...
function Constituency({ voter, constituency, setVoterData, setConstData }) {
    ...
    return (
        <>  
            ...
            <div className='row overflow-hidden const' style={{height:"44.75rem"}}>
                ...
                <div className='col-8'>
                    ...
                    <div className='row'>
                        <button onClick={()=> nextbutton()} className="mt-5 me-5 fixed-end ms-auto float-end" style={{background:"#5522D0", color:"white", width:"15%"}}>Next</button>
                    </div>
                </div>
            </div>
        </>
